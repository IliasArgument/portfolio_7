...
document.querySelector('.burger').addEventListener('click', function () {
    ...
    return document.querySelector('.menu__list').classList.toggle('active');
})
function tabs() {

    document.querySelectorAll(".tabs__header-item").forEach(el => {
        el.addEventListener("click", () => {
            let tab = +el.getAttribute("data-tab");

            document.querySelectorAll(".tabs__content-item").forEach(item => {
                item.classList.remove("active");
            });
            document.querySelectorAll(".tabs__header-item").forEach(item => {
...
const swiper = new Swiper('.swiper', {
    ...
    // Navigation arrows
    navigation: {
        nextEl: '.arrow__brn-next',
        prevEl: '.arrow__brn-prev',
    },
    breakpoints: {
